...
public class TablaDAOUser extends SQLiteDataHelper{
    ...
    //Insertar datos
    public boolean insertUser(String CEDULA_PERFIL_NOMBRE, String CONTRASENA_PERFIL_NOMBRE, String USUARIO_PERFIL_NOMBRE, int MASID) throws NetworkException  {
        String query = " INSERT INTO PERFIL (CEDULA_PERFIL_NOMBRE, CONTRASENA_PERFIL_NOMBRE, USUARIO_PERFIL_NOMBRE, MASID) VALUES(?, ?, ?, ?),";
        try {
            Connection          conn = openConnection();
            PreparedStatement pstmt  = conn.prepareStatement(query);
    ...
    public boolean updateUser(String USUARIO_PERFIL_NOMBRE, String NOMBRE_NUEVO) throws NetworkException  {
        ...
        public boolean deleteUser(int MASID) throws NetworkException{
            String query = "UPDATE PERFIL SET PERFIL_ESTADO = 'X' WHERE MASID = ?";
            try {
            Connection          conn = openConnection();
            PreparedStatement pstmt  = conn.prepareStatement(query);
